#!/usr/bin/env python3
"""
PS-10 Master Execution Script - UPDATED WITH FORMAT CORRECTION

🚨 CRITICAL FIX INTEGRATED: 
Automatically corrects filenames to PS-10 format: Change_Mask_LAT_LONG.tif
...
class PS10Master:
    ...
    def run_inference(self, input_dir, output_dir):
        ...
        cmd = [
            sys.executable, "oct31_rapid_inference.py",
...
def main():
    parser = argparse.ArgumentParser(description="PS-10 Master Execution Script")
